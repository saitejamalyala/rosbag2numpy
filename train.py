...
if __name__=='__main__':
    ...
    #Load dataset
    ds_loader = dataset_loader(tfrec_dir=params.get("dataset_dir"),batch_size=params.get("H_BATCH_SIZE"),shuffle_buffer=params["H_SHUFFLE_BUFFER"])
    ...
    #Model training
    history = pp_model.fit(ds_train,epochs=50,validation_data=ds_valid, 
                callbacks=[cb_reduce_lr,WandbCallback(),
                cb_log_pred(ds_test=ds_test,np_test_dataset=np_ds_test)])
