...
class dataset_loader:
    ...
    def __calc_opt_path_cost_wrt_costmap(self,costmap,gt_opt_path):
        ...
        for j in range(25):
            ...
            true_dist  = tf.math.sqrt(tf.reduce_sum(tf.math.square(valid_indices[:,1:] - gt_opt_path[j])))
    ...
    def __prepare_sample(self, example):
        ...
        #example["opt_path_cost"] = self.__calc_opt_path_cost_wrt_costmap(example["grid_map"],example["opt_path"])
