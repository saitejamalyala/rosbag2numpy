...
def nn(full_skip=False,params=None):
    ...
    # Block 1 
    #x_A = CoordinateChannel2D(use_radius=False)(ip_gridmap)
    x_A = add_channels(ip_gridmap)
    ...
    """
        ...
        x_A = layers.BatchNormalization()(x_A)
    """
    x_A = layers.Conv2D(32,kernel_size=1,strides=1)(x_A)

    x_A = layers.Conv2D(3,kernel_size=1,strides=1)(x_A)
