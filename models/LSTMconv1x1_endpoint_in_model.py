...
def nn(full_skip=False,params=None):
    ...
    output = layers.LSTM(units=50,return_sequences=True)(output)
    #tf.compat.v1.keras.layers.CuDNNLSTM(50,return_sequences=True)(output)
    #output = layers.LSTM(50,return_sequences=True)(output)
    #output = layers.LSTM(50)(output)
    output = layers.LSTM(units=50)(output)
    #tf.compat.v1.keras.layers.CuDNNLSTM(50)(output)
    ...
    #output = layers.RepeatVector(50)(output)
